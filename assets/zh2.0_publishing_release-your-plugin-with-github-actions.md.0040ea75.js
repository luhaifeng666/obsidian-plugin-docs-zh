import{_ as s,c as a,o as n,a as l}from"./app.741f1ead.js";const u=JSON.parse('{"title":"Release your plugin with GitHub Actions","description":"","frontmatter":{},"headers":[{"level":2,"title":"Use standard-version to automatically tag your release","slug":"use-standard-version-to-automatically-tag-your-release"}],"relativePath":"zh2.0/publishing/release-your-plugin-with-github-actions.md","lastUpdated":1661305878000}'),e={name:"zh2.0/publishing/release-your-plugin-with-github-actions.md"},p=l(`<h1 id="release-your-plugin-with-github-actions" tabindex="-1">Release your plugin with GitHub Actions <a class="header-anchor" href="#release-your-plugin-with-github-actions" aria-hidden="true">#</a></h1><p>Manually creating your plugin release can be time-consuming and error-prone. In this guide, you&#39;ll configure your plugin to use <a href="https://github.com/features/actions" target="_blank" rel="noreferrer">GitHub Actions</a> to automatically create a release when you create a new tag.</p><p>:::note The GitHub Action workflow was originally created and shared by <a href="https://forum.obsidian.md/u/argentum" target="_blank" rel="noreferrer">argentum</a>. For more information and other variations, refer to the <a href="https://forum.obsidian.md/t/using-github-actions-to-release-plugins/7877/3" target="_blank" rel="noreferrer">forum announcement</a>. :::</p><ol><li><p>In the root directory of your plugin, create a file called <code>release.yml</code> under <code>.github/workflows</code> with the following content:</p><div class="language-bash"><button class="copy"></button><span class="lang">bash</span><pre><code><span class="line"><span style="color:#A6ACCD;">name: Release Obsidian plugin</span></span>
...
<span class="line"></span></code></pre></div></li><li><p>Create a release and update the changelog.</p><div class="language-bash npm2yarn"><button class="copy"></button><span class="lang">bash npm2yarn</span><pre><code><span class="line"><span style="color:#A6ACCD;">npm run release</span></span>
<span class="line"></span></code></pre></div><p>:::note By default, if the major version is below <strong>1</strong>, for example in 0.3.4, <code>feat:</code> and <code>BREAKING CHANGE:</code> bump the patch and minor versions, respectively, rather than the minor and major versions. To bump the minor and major version:</p><div class="language-bash npm2yarn"><button class="copy"></button><span class="lang">bash npm2yarn</span><pre><code><span class="line"><span style="color:#676E95;"># Release as minor</span></span>
...
<span class="line"></span></code></pre></div><p>:::</p></li><li><p>Push the new tag to GitHub.</p><div class="language-bash"><button class="copy"></button><span class="lang">bash</span><pre><code><span class="line"><span style="color:#A6ACCD;">git push --follow-tags origin main</span></span>
<span class="line"></span></code></pre></div><ul><li><code>main</code> is the name of the remote branch you want to push to.</li></ul></li></ol><p>GitHub builds and releases the plugin using GitHub Actions.</p>`,16),o=[p];function t(r,c,i,y,A,C){return n(),a("div",null,o)}const d=s(e,[["render",t]]);export{u as __pageData,d as default};

import{_ as s,c as a,o as n,a as l}from"./app.53dc89cf.js";const D=JSON.parse('{"title":"Release your plugin with GitHub Actions","description":"","frontmatter":{"title":"Release your plugin with GitHub Actions"},"headers":[{"level":2,"title":"Use standard-version to automatically tag your release","slug":"use-standard-version-to-automatically-tag-your-release"}],"relativePath":"zh2.0/publishing/release-your-plugin-with-github-actions.md","lastUpdated":1661320642000}'),e={name:"zh2.0/publishing/release-your-plugin-with-github-actions.md"},p=l(`<h1 id="release-your-plugin-with-github-actions" tabindex="-1">Release your plugin with GitHub Actions <a class="header-anchor" href="#release-your-plugin-with-github-actions" aria-hidden="true">#</a></h1><p>Manually creating your plugin release can be time-consuming and error-prone. In this guide, you&#39;ll configure your plugin to use <a href="https://github.com/features/actions" target="_blank" rel="noreferrer">GitHub Actions</a> to automatically create a release when you create a new tag.</p><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The GitHub Action workflow was originally created and shared by <a href="https://forum.obsidian.md/u/argentum" target="_blank" rel="noreferrer">argentum</a>. For more information and other variations, refer to the <a href="https://forum.obsidian.md/t/using-github-actions-to-release-plugins/7877/3" target="_blank" rel="noreferrer">forum announcement</a>.</p></div><ol><li><p>In the root directory of your plugin, create a file called <code>release.yml</code> under <code>.github/workflows</code> with the following content:</p><div class="language-bash"><button class="copy"></button><span class="lang">bash</span><pre><code><span class="line"><span style="color:#A6ACCD;">name: Release Obsidian plugin</span></span>
